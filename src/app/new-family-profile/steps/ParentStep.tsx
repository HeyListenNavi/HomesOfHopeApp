        ...
        <View className="bg-white gap-4 p-6 rounded-2xl">
            ...
            <View className="px-1 gap-4">
                ...
                <Select
                    ...
                    onValueChange={(t: any) => onChange("civilState", t)}
                />
                ...
                <Select
                    ...
                    id="religion"
                    value={data.religion ?? ""}
                    onValueChange={(t: any) => onChange("religion", t)}
                    options={[
                        { label: "Católica", value: "catolica" },
                        { label: "Cristiana / Evangélica", value: "cristiana" },
                        {
                ...
                {data.hasGovSupport && (
                    <Textarea
                        ...
                        onChangeText={(t: string) => onChange("govSupport", t)}
                    />
                )}
                ...
                <Checkbox
                    ...
                    onCheckedChange={(val: boolean) => onChange("hasVisa", val)}
                />
                ...
                <Textarea
                    ...
                    onChangeText={(t: string) => onChange("referralSource", t)}
                />
            </View>
        </View>
    </StepContainer>
