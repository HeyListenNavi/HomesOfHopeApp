      ...
      <FullWindowOverlay>
        <SelectPrimitive.Overlay style={Platform.select({ native: StyleSheet.absoluteFill })}>
          <TextClassContext.Provider value="text-popover-foreground">
            <NativeOnlyAnimatedView className="z-50" entering={FadeInUp.duration(150)} exiting={FadeOutUp.duration(150)}>
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      <SelectPrimitive.ItemText className="text-gray-800 group-active:text-accent-foreground select-none text-base" />
    </SelectPrimitive.Item>
  );
}
